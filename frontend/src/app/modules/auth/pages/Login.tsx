...
export function Login() {
  ...
  const primaryColor = tenant?.themeConfig?.primaryColor || "#1e3a8a";
  ...
  const roles = [
    ...
    { id: "faculty" as UserRole, label: "Faculty", icon: "👨‍🏫" },
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 mb-4 group">
            <div className="bg-white p-3 rounded-xl group-hover:scale-105 transition-transform shadow-lg">
              {tenant?.logo ? (
                <img src={tenant.logo} alt={collegeName} className="w-8 h-8 object-contain" />
              ) : (
                <GraduationCap className="w-8 h-8 text-blue-900" />
              )}
            </div>
            <span className="text-2xl font-bold text-white">{collegeName}</span>
          </Link>
          <h1 className="text-3xl font-bold text-white mb-2">Welcome Back</h1>
          <p className="text-gray-300">Sign in to access your {collegeName} portal</p>
        </div>
        ...
        <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm font-semibold text-blue-900 hover:text-indigo-700">
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ background: `linear-gradient(to right, ${primaryColor}, #4338ca)` }}
              className="w-full px-6 py-4 text-white rounded-xl hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center space-x-2 group disabled:opacity-50"
            >
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full px-6 py-3 bg-white border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center space-x-2"
            >
